...
namespace TetrisLibrary
{
	...
	public class ShapeProxy : IShapeFactory, IShape
	{
		...
		public void DeployNewShape()
		{
			...
			switch (shape)
			{
				case 0:  current = new ShapeO(board);
						 break;
				case 1:  current = new ShapeI(board);
						 break;
				case 2:  current = new ShapeS(board);
						 break;
				case 3:  current = new ShapeT(board);
						 break;
				case 4:  current = new ShapeZ(board);
						 break;
				case 5:  current = new ShapeL(board);
						 break;
				default: current = new ShapeJ(board);
						 break;
			}
